...
set SYNOPSYS_TOOL "icc-par"

source -echo -verbose ${CELLS_TCL}

# ctorng: have to add this since the reference scripts use this name, but
# I want to keep our naming (same as mep2016)

set FILLER_CELL_METAL $STDCELLS_FILLER_CELLS
